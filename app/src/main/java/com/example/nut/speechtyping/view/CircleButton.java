package com.example.nut.speechtyping.view;
...
public class CircleButton extends ImageView {
    ...
    private static float SHADOW_CONSTANT = 0.075F;
    private int buttonColor = Color.WHITE;
    private int shadowColor = Color.GRAY;

    private static final int PRESSED_COLOR_LIGHTUP = 255 / 25;
    private static final int PRESSED_RING_ALPHA = 70;
    ...
    public void setShadowColor(int shadowColor) {
        ...
        circlePaint.setShadowLayer(outerRadius * SHADOW_CONSTANT, 0, 0, shadowColor);
        invalidate();    }
    ...
    public void setButtonColor(int buttonColor) {
        ...
        circlePaint.setColor(buttonColor);
        invalidate();    }
}
